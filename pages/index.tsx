...
const Home: NextPage = () => {
  return (
    <div className="text-slate-800 bg-slate-50 overflow-hidden">
      ...
      <header className="flex flex-col items-center p-10 md:p-16 text-center font-bold relative">
        ...
        <div className="z-10 flex flex-col-reverse md:flex-row gap-4 mb-0 md:mb-10 my-10 text-slate-900">
          <a
            href="#"
      ...
      <main>
        <section className="relative flex flex-col gap-16 px-3 md:px-40 pb-40 pt-8 md:pt-20 mx-auto">
          <div className="flex justify-center flex-wrap gap-16">
            <div className="w-96 bg-slate-50">
              <div className="bg-slate-200 h-52 md:h-96">
                <img alt="hehe" />
              </div>
              <div className="flex flex-col gap-4 px-6 py-6 md:py-10 border-2">
                <h4 className="text-brand text-xl font-bold">Single Layer</h4>
                <p>
      ...
      <footer>
        <div className="max-w-7xl mx-auto py-12 px-4 overflow-hidden sm:px-6 lg:px-8">
          ...
          <p className="mt-8 text-center text-base text-gray-400">
            &copy; 2020 Zirconn, Inc. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
